  ...
  Meteor.call('countRegisteredUsers', registeredUserCounter)
    ...
    function addRegUsers(ruCount){
      if(ruCount === 0){
        ...
        {email:"jactate@bellsouth.net" , roles:["Moms on a Mission", "adult"]},
        {email:"brettb517@gmail.com" , roles:["The team that shall not be named", "family"]},
        {email:"echinboukas@liberty.edu" , roles:["The Chin-Tastic 4!", "family"]},
        ...
        {email:"acgabig@gmail.com" , roles:["Smarty Pants", "adult"]},
        {email:"shera@techunlimited.net" , roles:["Wafflesons", "adult"]},

        {email:"lola.santos.priego@gmail.com", roles:['Familia Peluche', "family"]},
        {email:"sarahjcross@gmail.com", roles:["Don't Cross Us!", "adult"]},
        {email:"tina_beri@yahoo.com", roles:["Cary Newbies", "adult"]},
        {email:"albrun69@gmail.com", roles:["The Flashes", "family"]},
    ...
    if(qCount === 0){
          ...
          //a point value of -1 indicates a variable point question.
            var questionsArray =[
              [false, true, false, '', false, "Kramden Institute refurbishes used computers and laptops to donate them to kids without access at home. They accept laptops, CPUs, monitors, cellphones and peripherals. Did you bring any donations this morning? Show your Kramden tax receipt to get extra points today. CAPPED at 500 pts", '', false, '', -1, '', false, false, 1],
              [false, true, false, '', false, "Dorcas Ministries operates a very successful food pantry right here in Cary. Did you drop off non-perishables today at Morning Check-in? Please show your receipt.", '', false, '', -1, '', false, false, 2],
              [false, true, false, '', false, "Operation Eagle sends our overseas troops care packages as part of their mission. Did you drop off socks this morning when you checked in? Show your receipt", '', false, '', -1, '', false, false, 3],
              [false, false, true, '', false, "Years ago this sculpture was in another station, Did it 'Getaway' to its new location? Have a team member climb inside and take a seat. Take their photo: it will look pretty neat. TEAM MEMBER PHOTO", '', false, '', 175, '', false, false, 4],
              [false, false, true, '', false, "Dragon Boats will race on Symphony Lake today. Asian Focus brings this unique Chinese event annually to Cary. Take a photo with a boat. TEAM PHOTO", '', false, '', 225, '', false, false, 5],
              [false, false, true, '', false, "While you're eating Thanksgiving turkey, this high school's marching band will travel far. Find where they practice and take your team photo on the star TEAM PHOTO", '', false, '', 185, '', false, false, 6],
              [false, false, true, '', false, "Waverly Place continues to grow and evolve, find one of the three newest places is the puzzle you'll solve. Here's a hint: Think beauty, fitness and wellness. Take a team photo in front of just one for your points. TEAM PHOTO", '', false, '', 250, '', true, false, 7],
              [false, true, false, '', false, "This farm in the west started their Agri-tourism business  last fall with pumpkins, hayrides and a corn maze to test. You can see cotton getting ripe by Louis Stevens Road now I bet. Pick a bole and bring back proof of your visit. ITEM", '', false, '', 250, '', false, false, 8],
              [false, false, true, '', false, "Rodney Carroll created this iconic statue in 1999 and it's come to stand for Cary by and by. Go find it and take your team photo interacting with our town symbol TEAM PHOTO", '', false, '', 125, '', false, false, 9],
              [false, false, true, '', false, "These charming quiet children sit with their dog on a bench downtown- take a seat between them to show you're a mensch. Then take your photo TEAM MEMBER PHOTO", '', false, '', 55, '', false, false, 10],
              [false, false, true, '', false, "Part A)Carolina Orthodontics & Children's Dentistry and Triangle Family Dentistry at Cary Park are conveniently located in the same office suite. They can serve all your dental needs from your first tooth to your last tooth and all the crowding in between!  Take a team photo with the tooth fairy to prove you were there! TEAM PHOTO", '', false, '', 400, '', true, false, 11],
              [false, true, false, '', false, "Part B) Triangle Family Dentistry has a 2nd location down the road in Morrisville- make a visit and pick up a White Now! button. Show up at the finish with your team captain wearing the button for these points. ITEM", '', false, '', 300, '', true, false, 11.5],
              [false, false, true, '', false, "Rated the top public high school in NC, 'Dare to Soar' with the 'spirit of the falcon' on this campus. Take a team photo flapping your wings with this bird. TEAM PHOTO", '', false, '', 155, '', false, false, 12],
              [false, true, false, '', false, "A tennis championship named for one of our sponsors takes place here today. As proof of your visit bring back an order of play. ITEM", '', false, '', 230, '', false, false, 13],
              [true, false, false, '', false, "Find the statue of Walter Hines Page. He was a notable scholar, author, social reformer and ambassador to Great Britain. He's holding a book looking like a sage. What date was the book published to prove your visit was certain? ANSWER", '', false, '', 85, '', false, false, 14],
              [false, false, true, '', false, "Maximillians has been in Cary 25 years, and in 2016 the Hennessees bought it -everyone cheered! Come have a seat where their family's displayed. Take your team photo to prove that you played TEAM PHOTO", '', false, '', 250, '', true, false, 15],
              [true, false, false, '', false, "A park is named for this former mayor who guided the growth of Cary including the installation of our first water treatment plant. Find the statue of this man- who is he and when did he serve?", '', false, '', 95, '', false, false, 16],
              [false, true, false, '', false, "So many programs and events take place, this Program Guide might help you win the race. The Fall 2016 Parks Recreation and Cultural Resources Guide has it all.  Find one today and you will be set for the fall. ITEM", '', false, '', 50, '', false, false, 17],
              [false, false, true, '', false, "Ashworth's Drugstore is the longest continually operating drugstore in Cary. Over 60 years they've served Cary customers with the courtesy they deserved. Pay them a visit, come on inside to find the mannequinn wearing Ashworth's tshirt with pride. Put your arm around him and shout HOTDOG! for your team photo", '', false, '', 350, '', true, false, 18],
              [false, false, true, '', false, "Cary has 3 community centers that offer a variety of classes and activities but only one offers fencing. Have your team don masks and have a team photo taken by staff. UPLOAD TEAM PHOTO", '', false, '', 300, '', false, false, 19],
              [false, false, true, '', false, "Cary's unique skate, bike and scooter park recently added a mural. Check the hours! Visit and have staff take your team photo in front of it.. UPLOAD TEAM PHOTO", '', false, '', 120, '', false, false, 20],
              [true, false, false, '', false, "During renovation of this downtown theater an actual piece of film was found. Name the film and the stars", '', false, '', 75, '', false, false, 21],
              [true, false, false, '', false, "This converted school has lots of history. Find the plaque in The Hall that states 'proud traditions' and lists all the Principals - name them. ENTER ALL NAMES IN PHONE APP for 175 pts total (all or nothing)", '', false, '', 175, '', false, false, 22],
              [false, false, true, '', false, "I spy with my little eye - Cary Family Eye Care in their newly expanded location. They evaluate the entire eye for Glaucoma, Cataracts, or anything they spy. Have every team member put on a pair and snap a team photo to complete the equation. UPLOAD TEAM PHOTO for 250 pts", '', false, '', 250, '', true, false, 23],
    [false, false, true, '', false, "Cary's C Tran expands ridership every year. It's a very good service from what we hear. On Maynard and Kildaire sit many cool shelters, they have art too so you won't swelter. Take a team photo sitting in a bus shelter with art visible. Extra points: Hold up a C-Tran BUS schedule!!! TEAM PHOTO", '', false, '', 250, '', false, false, 24],
    [false, true, false, '', false, "Cary's C Tran expands ridership every year. It's a very good service from what we hear. On Maynard and Kildaire sit many cool shelters, they have art too so you won't swelter.  Extra points: Collect a C-Tran BUS schedule!!! TEAM PHOTO", '', false, '', 50, '', false, false, 24.5],
              [false, false, true, '', false, "Carpenter Farm Supply Co has been operating in Cary since 1895, and once served as the Carpenter post office. Pay them a visit and take a photo with the Company sign plainly visible TEAM PHOTO", '', false, '', 127, '', false, false, 25],
              [false, false, true, '', false, "Did you know the Catamount's school is 10 years old this fall? Show your claws when you find the sign with the date and take your team's photo TEAM PHOTO", '', false, '', 155, '', false, false, 26],
              [false, false, true, '', false, "Whether you call it table tennis or ping pong, at Triangle Table Tennis you can’t go wrong, as your team takes a table to play at the largest facility in the USA. Take a team photo playing table tennis today TEAM PHOTO", '', false, '', 350, '', true, false, 27],
              [false, false, true, '', false, "here's a beach in Cary. Find it and take a photo on the shore TEAM PHOTO", '', false, '', 125, '', false, false, 28],
              [false, false, true, '', false, "This water tower is the coolest in town, it's painted every year, they're not tearing it down. Can you take a photo with the new class of 2017 shown in the background? TEAM PHOTO", '', false, '', 100, '', false, false, 29],
              [false, true, false, '', false, "This library is growing and will soon move down the road to become a Wake County Regional we are told. Use your library card today to check out a book. Then bring back your reciept for the judges to take a look. ITEM", '', false, '', 90, '', false, false, 30],
              [false, true, true, '', false, "A) Orangetheory Fitness uses heart-rate monitor technology to make you work hard, mixing cardio and weights right from the start. Visit them in Morrisville and take a picture with a staff member… if you can get them to stand still! Pick up your folder, it's what you need to do, to complete this task and get credit for your clue TEAM PHOTO AND ITEM", '', false, '', 200, '', true, false, 31],
              [false, false, true, '', false, "B) Orangetheory Fitness's newest location in Cary is out West where everything's new. Find the large Splat logo and take a team photo, its what you need to do TEAM PHOTO", '', false, '', 200, '', true, false, 31.5],
              [false, false, true, '', false, "Bonus: If there was a class going on while you were there - extra bonus of 25 points", '', false, '', 25, '', false, false, 31.75],
              [true, false, false, '', false, "Reading is the 'Cornerstone' for so many things. Find this art at a library, and see what it brings. Roman numerals on one bench can be seen, Translate what they say if you are so keen.  ANSWER", '', false, '', 75, '', false, false, 32],
              [false, false, true, '', false, "The game of Cricket is played here today. It's not very far; it's on your way. Try to meet a player to take a team photo. TEAM PHOTO", '', false, '', 205, '', false, false, 33],
              [false, true, false, '', false, "If you are a Cary town resident you can take your trash to the Convenience Center, its evident. They'll take even TVs that don't work any more, pick up the Talk Trash brochure so you know the score . ITEM", '', false, '', 55, '', false, false, 34],
              [false, true, false, '', false, "Many think this high school is in Apex, but they'd be wrong. The stampede is strong in southern Cary. Find a Mustang and take a team photo TEAM PHOTO", '', false, '', 350, '', true, false, 35],
              [false, false, true, '', false, "At this kiosk 2 Cary greenways collide - White Oak and Black Creek on the East Coast Greenway reside. Take a photo to show your pride. TEAM PHOTO", '', false, '', 135, '', false, false, 36],
              [false, false, true, '', false, "'Mother always told you to eat a good breakfast'. This little spot has been open a year, did you know it? Have you been here? Find Bacon, Egg and Pancakes at The Egg & I and take your team photo. TEAM PHOTO", '', false, '', 250, '', true, false, 37],
              [false, false, true, '', false, "In a park named for a mayor this greenway does run. Tucked away in Lockmere, it's lots of fun. Find the Eagle Scout project and take a photo", '', false, '', 150, '', false, false, 38],
              [false, true, false, '', false, "Our pro soccer team is in Cary for good reason. Go to the stadium, there's games left in the season. To be sure you're on the up and up, bring back your souvenir Railhawks cup. ITEM", '', false, '', 225, '', false, false, 39],
              [false, false, true, '', false, "Make the Michelin Man part of your team! You'll find him at Atlantic Tire & Service. This year The NC Tire Industry awarded them Dealer of the Year. Find this award, now hold it up high and give us a cheer! Team Photo holding award with Michelin Man. TEAM PHOTO", '', false, '', 350, '', true, false, 40],
              [true, false, false, '', false, "In the children's nature trail of this Nature Center there's a mini scavenger hunt. Find the hidden mouse. Tell us where he lives ANSWER", '', false, '', 195, '', false, false, 41],
              [false, true, true, '', false, "The Friends of Page-Walker came up with a guide so you'll know Hillcrest Cemetery and what lies inside. The earliest burial is Nathaniel Jones. Bring a guide back and find his headstone among other famous Jones family members and take a TEAM PHOTO. Must have BOTH photo and & ITEM", '', false, '', 250, '', false, false, 42],
              [false, false, true, '', false, "This new memorial honors the victims and survivors of 2 American Eagle flights that crashed in Cary 6 years apart. Find this memorial and take a team photo.  TEAM PHOTO", '', false, '', 245, '', false, false, 43],
              [false, false, true, '', false, "The Shuckin' Shack Oyster Bar is a fun family place. Have a seat at the bar, they've saved you a space. Grab yourself an oyster and pick up a knife, they'll put you to work, having the time of your life. Ttake a team photo. TEAM PHOTO", '', false, '', 250, '', true, false, 44],
              [false, false, true, '', false, "Many think this high school is in Apex, but they'd be wrong. The stampede is strong in southern Cary. Find a Mustang and take a team photo TEAM PHOTO", '', false, '', 299, '', false, false, 45],
              [false, false, true, '', false, "Its call letters date back to the former longtime owner of the station, Durham Life Insurance Company, whose motto was 'We Protect The Family.' The studio is located in Raleigh, and the transmitter tower is in Cary. Go find the transmitter and see if you can take a team photo with the station call letters in the background. TEAM PHOTO", '', false, '', 200, '', false, false, 46],
              [false, false, true, '', false, "The Piedmont and Carolinian come to the Cary Depot twice a day. Get a schedule to learn when they arrive at Platform A.  Take a team photo with the train. Missed the train? Pick up a schedule and get some points. TEAM PHOTO = 350 pts  OR ITEM 100 pts", '', false, '', 350, '', true, false, 47.0],
              [false, true, false, '', false, "Missed the train? Pick up a schedule, you will still earn some points", '', false, '', 100, '', false, false, 47.5],
              [true, false, false, '', false, "Reply Ob/Gyn & Fertility is a new kind of Ob/Gyn Clinic.  What makes Reply so unique?  Come find “Ferti the Uterus” at their office and ask her why!  And while you’re there, just for fun, take a team photo with Ferti and upload it to Facebook! Ask Ferti the Uterus, “What makes Reply so unique?”  ANSWER", '', false, '', 250, '', true, false, 48],
              [false, false, true, '', false, "This Pollinator Garden was just declared a Certified Wildlife Habitat by the National Wildlife Federation. The Cary Garden for Wildlife Program was created to bolster efforts for the Town to earn standing as a Community Wildlife Habitat. Join the effort to “make a beautiful and healthy space for the three Bs - birds, bees and butterflies” . FIND THE STONE and take a photo. PHOTO OF ITEM", '', false, '', 90, '', false, false, 49],
              [false, false, true, '', false, "Do you like donuts to start your day? Duck Donuts are warm, delicious & made-to-order your way. Have each team member pick out their own little duck. Then take your team photo with plenty of pluck  TEAM PHOTO", '', false, '', 250, '', true, false, 50],
              [true, false, false, '', false, "On Cary's 100th anniversary, a time capsule was buried. It will be opened 100 years hence. Find the Sue Rowland Courtyard where it's buried and tell us what year will it be opened. ANSWER", '', false, '', 180, '', false, false, 51],
              [true, false, false, '', false, "Find Curvacious Kiss by Russ RuBert in a park out west. To find it will put you all to the test. Now stand beneath it to find its secret - what does it do? ANSWER", '', false, '', 249, '', false, false, 52],
              [false, false, true, '', false, "The votes were cast --- Chick-fil-A is still America’s most beloved fast-food chain (according to the American Consumer Satisfaction Index). So, CELEBRATE with the COW that says 'Eat More Chicken'. Find her at her 'home' in Waverly Place and enjoy a new, delicious 'treat'. Take that team photo with this icon, enjoy your 'treat' and be on your way! TEAM PHOTO", '', false, '', 350, '', true, false, 53],
              [false, false, true, '', false, "This empty house was built in 1803. It is one of only two exisiting examples of Board and Batten construction in Wake County. It has been placed on the National Register of Historic Places. A project Downtown may cause this to move. Take a Team Photo on the Porch  TEAM PHOTO", '', false, '', 111, '', false, false, 54],
              [false, false, true, '', false, "The Waldo House is the second example of Board and Batten construction in Wake County. It was moved from its originalto become a Bridal Cottage. Find it and take your team photo TEAM PHOTO", '', false, '', 91, '', false, false, 55],
              [true, false, false, '', false, "Everyone knows this famous Town mural. There's so much history in every detail. Find the grocery store pictured within it and tell us its name if you think you can win it. ANSWER", '', false, '', 105, '', false, false, 56],
              [false, false, true, '', false, "Did you know Cary has a Liberty Tree? Find Cary's Liberty Tree Memorial. It honors the people who made America Free. Take a photo of the plaque to prove it. PHOTO", '', false, '', 150, '', false, false, 57],
              [false, false, true, '', false, "'Let the fun begin at the Mayton Inn', Cary's Downtown Hotel. Come in through the lobby where the decor is so lovely you'll want to stay a spell. Find the library across from Highball, the bar. Relax on a cozy couch, it's not very far. Take your team photo  TEAM PHOTO", '', false, '', 250, '', true, false, 58],
              [false, false, true, '', false, "Thrift Shop, food pantry, job training and more. Dorcas Ministries helps people in transition. It's 'Christian Community In Action' with volunteers galore. Try on clothes in the thrift shop and make an exhibition. TEAM PHOTO ", '', false, '', 150, '', true, false, 59],
              [false, false, true, '', false, "The park with 2 names is where kids of all abilities can play together. It's their Anniversary party today. Find the landmark: KATAL the dragon and have your team photo taken with him.  TEAM PHOTO", '', false, '', 85, '', false, false, 60],
              [false, false, true, '', false, "'Come bounce off the walls' in a Jumpstreet dodgeball court. Get your team together for a team photo, now be a good sport!  TEAM PHOTO", '', false, '', 250, '', true, false, 61.0],
          ...
          // //isSA, isItem, isPic, picUrl, hasItem, questionText, shortAnswer, isAnswered, answerTime, ptsAwarded, groupName, isSponsored, isVerified, questionNumber)
            ...
            {console.log("generating"+teamNames[team]+"'s questions");
              ...
              {
                Meteor.call('createQuestion', questionsArray[q][0], questionsArray[q][1], questionsArray[q][2], questionsArray[q][3], questionsArray[q][4], questionsArray[q][5], questionsArray[q][6], questionsArray[q][7], questionsArray[q][8], questionsArray[q][9], teamNames[team], questionsArray[q][11], questionsArray[q][12], questionsArray[q][13]);
    ...
    'click .yep': function (e) {
      ...
      if(tempQ.ptsAwarded === -1){
        ...
        $(".variableBtn").on('click', function(){
          ...
          console.log('variable btn click')
          event.preventDefault();
